...
const float MEAN_VEC[MEL_BINS] = {
    -2.36503386e+00, -2.35732746e+00, -2.49574113e+00, -2.64747596e+00,
    -2.69266129e+00, -2.70115089e+00, -2.74747682e+00, -2.71220279e+00};

const float STD_VEC[MEL_BINS] = {7.71226346e-01, 7.95406044e-01, 7.68092990e-01,
                                 7.45597601e-01, 7.07299590e-01, 6.86450541e-01,
                                 6.41674757e-01, 6.34908736e-01};
...
void rnn_denoiser_denoise(uint16_t x[RNND_NFFT], rnn_num_t g[RNND_NFFT]) {
  ...
  for (uint16_t i = 0; i < MEL_BINS; i++) {
    ...
    input[i] =
        ((log10f(1e-8f + (s / (3276.7 / 2))) - MEAN_VEC[i]) / STD_VEC[i]);
  }
